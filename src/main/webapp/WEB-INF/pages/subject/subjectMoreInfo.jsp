...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/css/subjectCss.css">
</head>
...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <c:import url="../static/searchContentForSubject.jsp"></c:import>
            <!-- right col -->
            <div style="height: 50px;"></div>
            <c:import url="../static/subjectMoreInfo.jsp"></c:import>
        </div>
        <!-- /.row (main row) -->
        <!-- /.container-fluid -->
    </section>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/subject.js"></script>
<script>
